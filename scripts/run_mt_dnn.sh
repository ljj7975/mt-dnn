#!/bin/bash
if [[ $# -ne 3 ]]; then
  echo "train.sh <batch_size> <gpu> <'base'/'large'>"
  exit 1
fi
prefix="mt-dnn-rte"
BATCH_SIZE=$1
...
model_dir="checkpoints/${3}_${prefix}_${optim}_answer_opt${answer_opt}_gc${grad_clipping}_ggc${global_grad_clipping}_${tstr}"
